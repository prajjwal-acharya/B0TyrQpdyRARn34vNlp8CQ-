"""Stub Phase 5 extraction subgraph for GST registration/return documents.
...
def build_gst_graph():
    """Compile and return the placeholder GST extraction subgraph."""
...
gst_graph = build_gst_graph()

__all__ = ["build_gst_graph", "gst_graph"]
