"""Stub Phase 5 extraction subgraph for salary slips.
...
def build_salary_slip_graph():
    """Compile and return the placeholder salary slip extraction subgraph."""
...
salary_slip_graph = build_salary_slip_graph()

__all__ = ["build_salary_slip_graph", "salary_slip_graph"]
