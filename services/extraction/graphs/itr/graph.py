"""Stub Phase 5 extraction subgraph for ITR (Income Tax Return) documents.
...
def build_itr_graph():
    """Compile and return the placeholder ITR extraction subgraph."""
...
itr_graph = build_itr_graph()

__all__ = ["build_itr_graph", "itr_graph"]
